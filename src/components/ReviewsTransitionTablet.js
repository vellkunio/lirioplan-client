...
class ReviewsTransitionTablet extends Component {
  ...
  render() {
    ...
    return (
      <div >
            ...
            <div style={{
                width: '400px', height: '320px', display: 'block',
                ...
                <p className="font-merriweather" style={{
                    ...
                    marginTop: '16px', width: '300px', whiteSpace: 'normal',
      ...
      export default ReviewsTransitionTablet